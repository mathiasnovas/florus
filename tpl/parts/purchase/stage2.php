<p class="info-box">Felter markert med "<span style="color: red;">*</span>" er obligatoriske.</p>

<label class="required" for="billing_address">Fakturaadresse</label>
<input type="text" id="billing_address" name="billing_address">

<label class="required" for="delivery_address">Leveringsadresse</label>
<input type="text" id="delivery_address" name="delivery_address">

<label class="required" for="card_text">Tekst på kortet</label>
<textarea name="" id="card_text" cols="30" rows="10"></textarea>

<label for="delivery_time">Ønsket leveringstidspunkt</label>
